...
@section('content')
    <section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto border-t border-slate-200 pt-10" data-aos="fade-up" data-aos-delay="200">
                <div><div class="text-3xl font-bold text-slate-900">500+</div><div class="text-sm text-slate-500 font-medium uppercase tracking-wide">Companies</div></div>
                <div><div class="text-3xl font-bold text-slate-900">12k+</div><div class="text-sm text-slate-500 font-medium uppercase tracking-wide">Candidates</div></div>
                <div><div class="text-3xl font-bold text-slate-900">98%</div><div class="text-sm text-slate-500 font-medium uppercase tracking-wide">Success Rate</div></div>
                <div><div class="text-3xl font-bold text-slate-900">24/7</div><div class="text-sm text-slate-500 font-medium uppercase tracking-wide">Support</div></div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="group relative bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:border-blue-500 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <p class="text-slate-600 mb-8 leading-relaxed">Post unlimited jobs, manage applicants with a drag-and-drop pipeline, and hire 3x faster.</p>
                ...
                <div class="group relative bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:border-emerald-500 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-slate-600 mb-8 leading-relaxed">Access exclusive job mandates, submit your candidates, and earn commissions transparently.</p>
                ...
                <div class="group relative bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:border-purple-500 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-slate-600 mb-8 leading-relaxed">Create a stunning profile, apply with one click, and get tracked by top companies.</p>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                <div class="flex gap-4" data-aos="fade-right">
                    ...
                    <div><h4 class="text-xl font-bold text-slate-900 mb-2">Lightning Fast Matching</h4><p class="text-slate-600">Our algorithms instantly match job requirements with candidate profiles.</p></div>
                </div>
                <div class="flex gap-4" data-aos="fade-right" data-aos-delay="100">
                    <div class="w-12 h-12 shrink-0 bg-white rounded-xl shadow-sm flex items-center justify-center text-primary">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </div>
                    <div><h4 class="text-xl font-bold text-slate-900 mb-2">Verified Profiles</h4><p class="text-slate-600">Every candidate and company is vetted to ensure quality and trust.</p></div>
                </div>
                <div class="flex gap-4" data-aos="fade-right" data-aos-delay="200">
                    ...
                    <div><h4 class="text-xl font-bold text-slate-900 mb-2">Real-time Updates</h4><p class="text-slate-600">Never wonder about your application status again. Get notified instantly.</p></div>
                </div>
                <div class="flex gap-4" data-aos="fade-left">
                    <div class="w-12 h-12 shrink-0 bg-white rounded-xl shadow-sm flex items-center justify-center text-primary">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                    </div>
                    <div><h4 class="text-xl font-bold text-slate-900 mb-2">Advanced Analytics</h4><p class="text-slate-600">Clients get deep insights into their hiring funnel and recruitment metrics.</p></div>
                </div>
                <div class="flex gap-4" data-aos="fade-left" data-aos-delay="100">
                    <div class="w-12 h-12 shrink-0 bg-white rounded-xl shadow-sm flex items-center justify-center text-primary">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                    </div>
                    <div><h4 class="text-xl font-bold text-slate-900 mb-2">Secure & Private</h4><p class="text-slate-600">Your data is encrypted and safe. We prioritize user privacy above all.</p></div>
                </div>
                <div class="flex gap-4" data-aos="fade-left" data-aos-delay="200">
                    <div class="w-12 h-12 shrink-0 bg-white rounded-xl shadow-sm flex items-center justify-center text-primary">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </div>
                    <div><h4 class="text-xl font-bold text-slate-900 mb-2">Global Reach</h4><p class="text-slate-600">Connect with talent or opportunities from anywhere in the country.</p></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative text-center text-white" data-aos="fade-up">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="/register/candidate" class="px-8 py-4 bg-white text-primary rounded-full font-bold shadow-lg hover:shadow-xl hover:bg-gray-50 transition-all">Sign Up Now</a>
                <a href="/login" class="px-8 py-4 bg-indigo-700 text-white rounded-full font-bold border border-indigo-500 hover:bg-indigo-800 transition-all">Login to Account</a>
            </div>
        </div>
    </section>
@endsection