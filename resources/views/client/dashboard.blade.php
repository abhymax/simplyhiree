...
<style>
    ...
    body { background-color: #020813 !important; font-family: 'Outfit', sans-serif; overflow-x: hidden; margin: 0; padding: 0; }
...
<div class="min-h-screen bg-[#020813] text-[#f8fafc] flex" x-data="{ sidebarOpen: false }">
