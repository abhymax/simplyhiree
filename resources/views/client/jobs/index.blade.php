                    ...
                    <div class="bg-white/5 backdrop-blur-md rounded-2xl shadow-xl border border-white/10 flex flex-col hover:bg-slate-900/40 hover:border-blue-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 relative group">
                        ...
                        <div class="p-6 flex-1 pt-8">
                            <div class="flex justify-between items-start mb-4 gap-3">
                                <h3 class="text-lg font-bold text-white line-clamp-2 leading-tight group-hover:text-cyan-300 transition duration-200" title="{{ $job->title }}">{{ $job->title }}</h3>
                            ...
                            <div class="space-y-2.5 mt-5 text-xs">
                                ...
                                <div class="flex items-center gap-3 mt-4 pt-2.5 border-t border-white/5">
