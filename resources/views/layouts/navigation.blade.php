            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('partner')
                        ...
                        <x-nav-link :href="route('partner.candidates.index')" :active="request()->routeIs(['partner.candidates.index', 'partner.candidates.create'])">
                            {{ __('My Candidates') }}
                        </x-nav-link>
                        <x-nav-link :href="route('partner.applications')" :active="request()->routeIs('partner.applications')">
                            {{ __('My Applications') }}
                        </x-nav-link>
                        <x-nav-link :href="route('partner.earnings')" :active="request()->routeIs('partner.earnings')">
                            {{ __('Earnings') }}
                        </x-nav-link>
                    @endrole
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('partner')
                ...
                <x-responsive-nav-link :href="route('partner.candidates.index')" :active="request()->routeIs(['partner.candidates.index', 'partner.candidates.create'])">
                    {{ __('My Candidates') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('partner.applications')" :active="request()->routeIs('partner.applications')">
                    {{ __('My Applications') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('partner.earnings')" :active="request()->routeIs('partner.earnings')">
                    {{ __('Earnings') }}
                </x-responsive-nav-link>
            @endrole
