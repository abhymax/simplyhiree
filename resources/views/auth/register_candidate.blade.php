<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register.candidate') }}" class="space-y-4">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {{-- Row 2: WhatsApp OTP Verification --}}
            <div class="md:col-span-2">
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button" id="send_candidate_otp_btn" class="mt-1 px-4 py-2 rounded-xl bg-indigo-600 text-white text-xs font-semibold hover:bg-indigo-500 whitespace-nowrap">Send OTP</button>
                    <button type="button" id="verify_candidate_otp_btn" class="mt-1 px-4 py-2 rounded-xl bg-emerald-600 text-white text-xs font-semibold hover:bg-emerald-500 whitespace-nowrap">Verify</button>
                </div>
                <p id="candidate_otp_status" class="mt-2 text-xs text-gray-400"></p>
