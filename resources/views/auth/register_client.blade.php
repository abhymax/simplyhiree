<x-guest-layout>
    <div class="mb-6">
        <h2 class="text-2xl font-black text-white tracking-tight">Register as Employer</h2>
        <p class="text-slate-400 text-xs mt-1">Acquire elite talent sourced directly by pre-vetted agency partners.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register.client') }}" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {{-- Row 2: Official Email & Service Required --}}
            <div>
            ...
            {{-- Row 5: WhatsApp OTP Verification --}}
            <div class="md:col-span-2">
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button" id="send_client_otp_btn" class="mt-1 px-4 py-2 rounded-xl bg-indigo-600 text-white text-xs font-semibold hover:bg-indigo-500 whitespace-nowrap">Send OTP</button>
                    <button type="button" id="verify_client_otp_btn" class="mt-1 px-4 py-2 rounded-xl bg-emerald-600 text-white text-xs font-semibold hover:bg-emerald-500 whitespace-nowrap">Verify</button>
                </div>
                <p id="client_otp_status" class="mt-2 text-xs text-gray-400"></p>
