            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.partners.store') }}" class="space-y-6">
                        ...
                        <div>
                            <x-input-label for="name" :value="__('Partner / Agency Name')" />
                        ...
                        <div>
                            ...
                            <select id="company_type" name="company_type" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('admin.partners.index') }}" class="text-sm text-gray-600 underline hover:text-gray-900 mr-4">Cancel</a>
                            <x-primary-button>
                                {{ __('Create Partner') }}
                            </x-primary-button>
                        </div>
