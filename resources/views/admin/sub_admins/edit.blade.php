<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Manager: {{ $user->name }}</h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <form action="{{ route('admin.sub_admins.update', $user->id) }}" method="POST">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Change Password <span class="text-gray-400 font-normal">(Leave blank to keep current)</span></label>
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 shadow-md transition">Update Manager</button>
                </div>
            </form>
        </div>
    </div>
