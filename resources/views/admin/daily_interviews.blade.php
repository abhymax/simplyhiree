                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse($todayInterviews as $app)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="py-4 px-4">
                                        <div class="text-sm text-gray-800">{{ $app->job->company_name ?? 'N/A' }}</div>
                                    </td>
                                    <td class="py-4 px-4">
                                        <a href="{{ route('admin.applications.show', $app->id) }}" class="bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold py-2 px-4 rounded">
                                            View Details
                                        </a>
                                    </td>
                                </tr>
