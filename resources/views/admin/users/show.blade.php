                ...
                <div class="md:col-span-1">
                    <div class="bg-slate-900/60 backdrop-blur-xl border border-white/20 rounded-3xl p-6 shadow-2xl text-center">
                        ...
                        <div class="mt-6 pt-6 border-t border-white/10 text-left space-y-3">
                            ...
                            <div>
                                <span class="text-xs font-bold text-slate-500 uppercase block">Status</span>
                ...
                <div class="md:col-span-2 space-y-6">
                    <div class="bg-slate-900/60 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-lg">
                        <h3 class="text-xl font-bold text-white mb-6 flex items-center gap-2">
                            <i class="fa-solid fa-address-card text-emerald-400"></i> Personal Details
                        </h3>
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                <span class="text-xs font-bold text-slate-500 uppercase block mb-1">First Name</span>
                                <span class="text-white bg-white/5 px-3 py-2 rounded block">{{ $firstName }}</span>
                            </div>
                            <div>
                                <span class="text-xs font-bold text-slate-500 uppercase block mb-1">Last Name</span>
                                <span class="text-white bg-white/5 px-3 py-2 rounded block">{{ $lastName }}</span>
                            </div>
                            <div>
                    ...
                    <div class="bg-slate-900/60 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-lg">
                        <h3 class="text-xl font-bold text-white mb-6 flex items-center gap-2">
                            <i class="fa-solid fa-briefcase text-blue-400"></i> Professional Info
                        </h3>
