    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                <a href="{{ route('partner.candidates.index') }}" class="mt-4 inline-block text-indigo-600 font-semibold hover:underline">View Candidates &rarr;</a>
            </div>
            <!-- *** END OF NEW CARD *** -->
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                <a href="{{ route('partner.applications') }}" class="mt-4 inline-block text-indigo-600 font-semibold hover:underline">Manage Applications &rarr;</a>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                <a href="{{ route('partner.earnings') }}" class="mt-4 inline-block text-indigo-600 font-semibold hover:underline">View Earnings &rarr;</a>
            </div>
        </div>
