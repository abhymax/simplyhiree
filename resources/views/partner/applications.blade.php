                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border">
                        <thead class="bg-gray-100">
                            <tr>
                                <th classV="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Candidate</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse($applications as $app)
                                <tr>
                                    ...
                                    <td class="py-4 px-4 whitespace-nowrap">{{ $app->job->title }}</td>
                                    <td class="py-4 px-4 whitespace-nowrap">{{ $app->job->company_name }}</td>
