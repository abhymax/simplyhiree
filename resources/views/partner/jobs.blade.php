                    ...
                    <table class="min-w-full bg-white border">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Job Type</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse($jobs as $job)
                                <tr>
                                    ...
                                    <td class="py-4 px-4 whitespace-nowrap">{{ $job->job_type }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="py-4 px-4 text-center text-gray-500">No approved jobs are currently available.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
