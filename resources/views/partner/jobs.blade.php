                    ...
                    @forelse($jobs as $job)
                        <tr>
                            <td class="py-4 px-6 align-top">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">{{ $job->category->name ?? 'N/A' }}</p>
                            ...
                            <td class="py-4 px-6 align-top">
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        <span class="text-sm text-gray-700 w-24">{{ ucfirst(str_replace('_', ' ', $status)) }}</span>
                                        ...
                                        <span class="text-sm text-gray-600 font-semibold w-6 text-right">{{ $job->stats->$status }}</span>
                                    </div>
                                    @endforeach
                                </div>
                            </td>
                            ...
                            <td class="py-4 px-6 align-top text-center">
                                ...
                                <a href="{{ route('partner.jobs.showApplyForm', $job->id) }}" class="inline-block bg-indigo-600 text-white text-sm font-bold px-4 py-2 rounded shadow hover:bg-indigo-700 transition w-full">
                                    Apply Now
                                </a>
                            </td>
                        </tr>
